...
if (have_posts()) :
    while (have_posts()) : the_post();
        ...
        $sister_concern_title = get_field('single_service__title');
        if (!$sister_concern_title) {
            $sister_concern_title =  get_the_title();
        }
        ...
        $sister_concern_single_cat = get_field('our_services_all_service');
        ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            while ($loop->have_posts()) : $loop->the_post();
                ...
                <a href="<?php echo $sister_concern_single_service_link;?>" target="_blank"> 
                    <div class="our_service_div inner_our_service">
...
if (have_posts()) :
    while (have_posts()) : the_post();
        $sister_concern_second_title = get_field('our_service_second_title');
        $sister_concern_second_content = get_field('our_service_second_content');
